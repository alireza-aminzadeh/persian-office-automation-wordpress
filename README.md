...
<p align="center">
  <a href="https://wordpress.org/plugins/persian-office-automation/">
    <img src="https://img.shields.io/wordpress/plugin/v/persian-office-automation?logo=wordpress&logoColor=white&label=WordPress.org&color=21759B" alt="Latest version on WordPress.org" />
  </a>
  <a href="https://wordpress.org/plugins/persian-office-automation/">
    <img src="https://img.shields.io/wordpress/plugin/installs/persian-office-automation?logo=wordpress&logoColor=white&label=active%20installs&color=46b450" alt="Active installs" />
  </a>
  <a href="https://wordpress.org/plugins/persian-office-automation/">
    <img src="https://img.shields.io/wordpress/plugin/dt/persian-office-automation?logo=wordpress&logoColor=white&label=downloads&color=0073AA" alt="Total downloads" />
  </a>
</p>

<h3 align="center">مخزن رسمی وردپرس · WordPress Plugin Directory</h3>

<p align="center">
  <a href="https://wordpress.org/plugins/persian-office-automation/"><b>دانلود، بررسی امتیاز و نصب مستقیم از وردپرس</b></a>
</p>
<p align="center">
  <a href="https://wordpress.org/plugins/persian-office-automation/"><b>Download, reviews &amp; one-click install — WordPress.org</b></a>
</p>
<p align="center">
  <a href="https://wordpress.org/plugins/persian-office-automation/"><code>https://wordpress.org/plugins/persian-office-automation/</code></a>
</p>

---

[![WordPress](https://img.shields.io/badge/WordPress-6.0%2B-21759B?logo=wordpress)](https://wordpress.org/plugins/persian-office-automation/)
...
- **نقش‌ها و دسترسی:** قابلیت‌های سفارشی (مثل `persian_oa_create_letter`, `persian_oa_view_letter`) برای کنترل دسترسی دقیق.
...
- **Roles & capabilities:** Custom capabilities (e.g. `persian_oa_create_letter`, `persian_oa_view_letter`) for fine-grained access control.
...
1. Clone the repository into your plugins directory:
   ...
   git clone https://github.com/alireza-aminzadeh/persian-office-automation.git
   ```
...
**Alireza Aminzadeh**  
- GitHub: [@alireza-aminzadeh](https://github.com/alireza-aminzadeh)  
